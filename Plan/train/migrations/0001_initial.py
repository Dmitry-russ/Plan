# Generated by Django 2.2.16 on 2023-02-03 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('maintenance', models.CharField(choices=[('Vi', 'Vi'), ('I1', 'I1'), ('I2', 'I2'), ('I3', 'I3'), ('I4', 'I4'), ('I4+I5', 'I4+I5'), ('I5', 'I5'), ('I6', 'I6'), ('30', '30 суток'), ('Зима', 'Зима'), ('Лето', 'Лето'), ('-', '-'), ('Vi*', 'Vi*'), ('I1*', 'I1*'), ('I2*', 'I2*')], default='Vi', max_length=2, verbose_name='Вид ТО')),
                ('date_one', models.DateField(verbose_name='Дата начала ТО')),
                ('date_two', models.DateField(verbose_name='Дата окончания ТО')),
                ('place', models.CharField(blank=True, choices=[('Vi', 'Vi'), ('I1', 'I1'), ('I2', 'I2'), ('I3', 'I3'), ('I4', 'I4'), ('I4+I5', 'I4+I5'), ('I5', 'I5'), ('I6', 'I6'), ('30', '30 суток'), ('Зима', 'Зима'), ('Лето', 'Лето'), ('-', '-'), ('Vi*', 'Vi*'), ('I1*', 'I1*'), ('I2*', 'I2*')], default='ЕКБ', max_length=2, verbose_name='Место проведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('type', models.CharField(choices=[('Vi', 'Vi'), ('I1', 'I1'), ('I2', 'I2'), ('I3', 'I3'), ('I4', 'I4'), ('I4+I5', 'I4+I5'), ('I5', 'I5'), ('I6', 'I6'), ('30', '30 суток'), ('Зима', 'Зима'), ('Лето', 'Лето'), ('-', '-'), ('Vi*', 'Vi*'), ('I1*', 'I1*'), ('I2*', 'I2*')], default='Vi', max_length=5, verbose_name='Тип инспекции')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.CharField(choices=[('ЕКБ', 'Екатеринбург'), ('ЧЛБ', 'Челябинск'), ('Пермь', 'Пермь'), ('МСК', 'Москва'), ('СПБ', 'Санкт-Петербург'), ('Сочи', 'Сочи'), ('Крюково', 'Крюково')], default='ЕКБ', max_length=30, verbose_name='Место проведения')),
        ...
        migrations.AddConstraint(
            model_name='donemaidate',
            constraint=models.UniqueConstraint(fields=('train', 'maintenance'), name='train_maintenance_rel'),
        ),
        migrations.AddIndex(
            model_name='cases',
